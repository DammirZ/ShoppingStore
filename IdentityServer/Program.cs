    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                var samsungUser = new ApplicationUser("samsung");
                userManager.CreateAsync(samsungUser, "password").GetAwaiter().GetResult();
                userManager.AddClaimAsync(samsungUser, new Claim("samsung.admin", "true")).GetAwaiter().GetResult();
